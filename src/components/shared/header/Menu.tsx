...
export default function Menu() {
    ...
    // Truyền customerId vào hook để nó tự động load cart count
    ...
    return (
        <>
            <nav className="flex items-center gap-4">
                {customer ? (
                    <>
            <span className="header-button text-sm font-medium whitespace-nowrap">
              Hello, {customer.customerName}
            </span>
                        <button
                            className="header-button text-sm font-medium whitespace-nowrap"
